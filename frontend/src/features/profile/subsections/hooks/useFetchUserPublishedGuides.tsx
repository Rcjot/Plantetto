...
function useFetchUserPublishedGuides() {
    ...
    useEffect(() => {
        const fetchGuide = async () => {
            ...
            const res = await guidesApi.getUserPublishedGuides(
                username,
                search,
        ...
        fetchGuide();
    }, [page, search, categoryMap, selectedCategory, username]);
...
export default useFetchUserPublishedGuides;
