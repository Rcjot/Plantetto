...
function UsersPublishedGuidesSection() {
    ...
    return (
        <div className="flex flex-col gap-7 p-3 sm:p-10 max-w-4xl">
...
export default UsersPublishedGuidesSection;
