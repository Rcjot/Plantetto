...
function Sidebar({ children }: { children: React.ReactNode }) {
    ...
    const custom_hover_button =
        "flex items-center gap-3 p-2 rounded-xl transition text-xl hover:bg-base-300 active:bg-base-300";
    const sidebar_style =
    ...
    return (
        <div className="drawer lg:drawer-open flex-1 ">
            <input
                ...
                ref={drawerRef}
                type="checkbox"
                className="drawer-toggle transition"
            />
